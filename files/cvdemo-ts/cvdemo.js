...
class DemoApp {
    constructor() {
        this._imgSrc = null;
        this._canvasDst = document.querySelector("#canvas-dst");
        this._checkGamma = document.querySelector("#check-gamma");
        this._rangeGamma = document.querySelector("#range-gamma");
        this._spanGamma = document.querySelector("#span-gamma");
        this._checkContrast = document.querySelector("#check-contrast");
        this._rangeContrast = document.querySelector("#range-contrast");
        this._spanContrast = document.querySelector("#span-contrast");
        this._checkSharpness = document.querySelector("#check-sharpness");
        this._rangeSharpness = document.querySelector("#range-sharpness");
        this._spanSharpness = document.querySelector("#span-sharpness");
        this._checkMosaic = document.querySelector("#check-mosaic");
        this._rangeMosaic = document.querySelector("#range-mosaic");
        this._spanMosaic = document.querySelector("#span-mosaic");
        this._checkDithering = document.querySelector("#check-dithering");
        this._checkGrayscale = document.querySelector("#check-grayscale");
        this._checkBinary = document.querySelector("#check-binary");
        this._checkCenter = document.querySelector("#check-center");
    }
    start() {
    ...
    refreshGui() {
        ...
        const targets = document.querySelectorAll("#require-grayscaled input");
        for (const target of targets) {
